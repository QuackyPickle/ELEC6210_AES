...
set_property -dict { PACKAGE_PIN L12   IOSTANDARD LVCMOS33 } [get_ports { o_tx }]; #IO_L6N_T0_D08_VREF_14 Sch=uart_rxd_out
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { i_rx }]; #IO_L5N_T0_D07_14 Sch=uart_txd_in
