...
REM
REM Generated by Vivado on Wed Oct 29 22:14:07 -0500 2025
...
echo "xvlog --incr --relax -prj tb_all_together_vlog.prj"
call xvlog  --incr --relax -prj tb_all_together_vlog.prj -log xvlog.log
