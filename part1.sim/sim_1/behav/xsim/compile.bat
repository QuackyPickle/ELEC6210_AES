...
REM
REM Generated by Vivado on Wed Nov 05 21:22:39 -0600 2025
...
echo "xvlog --incr --relax -prj tb_key_generator_vlog.prj"
call xvlog  --incr --relax -prj tb_key_generator_vlog.prj -log xvlog.log
